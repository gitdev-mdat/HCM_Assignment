...
export const conditions = [
  {
    ...
    description:
      "Kế thừa truyền thống yêu nước, nhân nghĩa và đoàn kết. Như Hồ Chí Minh đã nói: 'Dân ta có một lòng nồng nàn yêu nước...'.",
  ...
  },
  {
    ...
    description:
      "'Trong bầu trời không gì quý bằng nhân dân. Trong thế giới không gì mạnh bằng lực lượng đoàn kết của nhân dân'. Nhân dân là gốc rễ, nền tảng của khối đoàn kết.",
